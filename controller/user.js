...
export const signIn = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ email: existingUser.email, id: existingUser._id }, 'storyWeb', { expiresIn: '1h' });
...
export const signUp = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ email: result.email, id: result._id }, 'storyWeb', { expiresIn: '1h' });
